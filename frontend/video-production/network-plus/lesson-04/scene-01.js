...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function runIntro(){
        ...
        schedule(()=>{
            ...
            activate("#accuracyBenefit");

        },2200);

        schedule(()=>{

            activate("#troubleshootingBenefit");
