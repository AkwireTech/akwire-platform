/* ==========================================
   ...
   LESSON 04 — SCENE 02
   NETWORK MONITORING & PERFORMANCE BASELINES
========================================== */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function runIntro(){
        ...
        schedule(()=>{
            ...
            activate("#visibilityBenefit");

        },2200);

        schedule(()=>{

            activate("#proactiveBenefit");
